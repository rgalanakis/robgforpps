...
As animals, we have brains because we move. In fact, there are animals like the Sea Squirt that lose their brain when they stop moving.
...
{% include policy-proposal.html slug="health" text="Use the trip to and from school for brain and body building exercise." %}
...
{% include policy-proposal.html slug="health" text="Better school start times through creative transportation." %}

In the 2024–2025 school year, PPS moved all elementary schools to begin at 8am (too early!) and middle schools to begin at 9:15am (too late!).
This was done to save a few million dollars on transportation costs.

What was the cost to student attendance and performance? Did we look at other options?

Aside from the broad impacts, consider how inequitable the current regime is:
...
PPS is an _urban_ school district, but transportation is based on the suburban and rural transportation model of yellow school buses and parents driving.
Instead, we should be piloting alternative transportation modes (widespread in Europe) that will reduce costs, allow better start times,
*and* get kids moving on the way to school. This is one of those changes that, once we do it, we'll wonder why it took us so long.
...
Studies show this additional exercise could lead to a significant increase in test scores and attendance.
It would also improve how kids get around the city and help re-establish Portland's cultural capital.
And it would be basically free for PPS.

{% include policy-proposal.html slug="health" text="Run the air purifiers we already have. Cleaner air leads to clearer thinking." %}
...
{% include policy-proposal.html slug="health" text="Roll out Idle Free Zone signage and education district-wide." %}
...
{% include policy-proposal.html slug="transportation" text="Make the Transportation Directory responsible for the reduction of car trips at neighborhood schools." %}
...
{% include policy-proposal.html slug="climate" text="Incorporate community impacts into the Climate Crisis Response Plan to provide a more holistic view of PPS emissions reductions or increases." %}
...
For example, urban households have 1/4 the GHG emissions of suburban households. By increasing enrollment, PPS would have a large emissions reduction impact. Money spent on certain direct GHG reductions may be better spent on enrollment increases.
...
While growth and density allow us to solve structural problems, it can also just kick the can down the road.
We need people who will put spending under scrutiny, to make sure our dollars contribute towards the right outcomes.
...
Washtintonians can exploit our amenities without paying a dime,
and we're bankrupting our schools to make it happen.
...
Far-fetched? Nope. The SUN Schools provide vital afterschool programming.
But SUN is a Multnomah County program, operated by Portland Parks & Rec, on PPS sites.
Unfortunately this means Portland Parks budget cuts can impact afterschol programming for PPS students.
...
- Align on reforms to Measures 5 and 50. We need to be careful when pointing fingers at these constitutional amendments;
  ...
  That said, Measures 5 and 50 have contributed to unproductive incentives, such as holding onto property well beyond when owners should.
...
{% include policy-proposal.html slug="civic" text="Lead the way on democratic good governance by adding a PAT representative to the PPS Board to ensure a healthy, strike-free relationship." %}
...
By commiting to partner with parents in designing and implementing solutions,
