...
Let's be honest: $1.8B is a massive bond, about 50% larger than the largest previous bond, which we passed in 2020.
There is a lot in this bond. I am not going to go over everything. I am going to list my concerns, and how I got over those concerns.

I'm going to start with the smaller stuff and end with the difficult ones (Jefferson High School).
