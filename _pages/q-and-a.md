...
so you can see I'm not just telling you what I think you want to hear.
...
While their only legal responsibility was to vote on contracts, they are also a democratically represented
...
We can do better! Why not [add a PAT representative to the board](/one-city#civic)?
...
The evidence shows that, to educate our kids well, nothing else beats public school systems.
'School choice' is an extremist/fundamentalist religious attempt to destroy civic society
...
But there may be compelling reasons charter schools may serve a small set of the population well.
PPS currently has four charter schools. This is a small enough amount that I doubt we can find evidence of significant
...
Evidence and experience show that nearly everyone is 1) doing the best they can, and 2) statistically average across most measures.
...
But the reality of high-performing groups is that they are given the supports and environment to succeed.
...
(it doesn't make a difference if we are talking about maximum or average sizes).
...
of classroom teachers, along with researchers, and the best effort from parents
...
Third is safety from discrimination. This is more challenging as it's another case where the school system
...
My problems with Measure 5 and 50 are that they create bad land use incentives (that reduce overall revenue by having fewer taxpayers),
...
(like a retired couple living alone in the home they raised children in), and investors who own underutilized lots
...
It would be more affordable and better for older adults, too, to directly subsidize their move to smaller houses or apartments.
...
Reform would also result in better land use. The better land use, not a higher tax rate, would result in more revenue.
